  ...
  routes: [
    ...
    { path: '/history', component: PublicHistory },
    {
      ...
      children: [
        ...
        { path: 'workbenches', redirect: '/app/terminals/me' },
        { path: 'enrollments', redirect: '/app/terminals/enrollments' },
        { path: 'terminals/me', component: () => import('./features/terminals/MyTerminalsPage.vue'), meta: { permission: 'workbench.read' } },
        { path: 'terminals/team', component: () => import('./features/terminals/TeamTerminalsPage.vue'), meta: { permission: 'workbench.team.read' } },
        { path: 'terminals/enrollments', component: () => import('./features/terminals/TerminalEnrollmentsPage.vue'), meta: { permission: 'workbench.enrollment.review' } },
