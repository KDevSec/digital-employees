...
> 关联决策：[Q 20260812-054528](../design/设计决策记录-2026-08-13.md)（单 Agent 形态定调）
...
> ⚠️ 本节基于 1.0 代码盘点。单 Agent 形态定调后（[Q 20260812-054528](../design/设计决策记录-2026-08-13.md)），这些发现对 2.0 绿地设计参考价值有限——降级为"1.0 迁移参考"而非"2.0 设计需求"。
